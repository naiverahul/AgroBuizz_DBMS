...
export const customers = pgTable("customers", {
  ...
  profileCreationDate: timestamp("profile_creation_date")
    .defaultNow()
    .notNull(),
...
export const farmerCrops = pgTable(
  "farmer_crops",
  {
    farmerId: varchar("farmer_id", { length: 50 })
      .notNull()
      .references(() => farmers.farmerId, { onDelete: "cascade" }),
    cropId: varchar("crop_id", { length: 50 })
      .notNull()
...
export const farmerInventories = pgTable(
  "farmer_inventories",
  {
    farmerId: varchar("farmer_id", { length: 50 })
      .notNull()
...
export const farmerCustomerTransactions = pgTable(
  "farmer_customer_transactions",
  {
    transactionId: varchar("transaction_id", { length: 50 }).primaryKey(),
    orderId: varchar("order_id", { length: 50 })
      .notNull()
      .references(() => farmerCustomerOrders.orderId, { onDelete: "cascade" }),
...
export const vendorFarmerTransactions = pgTable("vendor_farmer_transactions", {
  ...
  orderId: varchar("order_id", { length: 50 })
    .notNull()
    .references(() => vendorFarmerOrders.orderId, { onDelete: "cascade" }),
  paymentMode: varchar("payment_mode", { length: 50 }),
...
export const farmerCustomerFeedbacks = pgTable("farmer_customer_feedbacks", {
  ...
  orderId: varchar("order_id", { length: 50 })
    .notNull()
    .references(() => farmerCustomerOrders.orderId, { onDelete: "cascade" }),
  farmerId: varchar("farmer_id", { length: 50 }).references(
    () => farmers.farmerId,
    { onDelete: "set null" }
  ),
  customerId: varchar("customer_id", { length: 50 }).references(
...
export const vendorFarmerFeedbacks = pgTable("vendor_farmer_feedbacks", {
  ...
  vendorId: varchar("vendor_id", { length: 50 }).references(
    () => vendors.vendorId,
    { onDelete: "set null" }
  ),
  rating: integer("rating").notNull(),
...
export const insertFarmerInventorySchema =
  createInsertSchema(farmerInventories);
export const insertVendorInventorySchema =
  createInsertSchema(vendorInventories);
export const insertFarmerCustomerOrderSchema = createInsertSchema(
  farmerCustomerOrders
).omit({ orderDate: true });
export const insertVendorFarmerOrderSchema = createInsertSchema(
  vendorFarmerOrders
).omit({ orderDate: true });
export const insertFarmerCustomerTransactionSchema = createInsertSchema(
  farmerCustomerTransactions
).omit({ transactionTimestamp: true });
export const insertVendorFarmerTransactionSchema = createInsertSchema(
  vendorFarmerTransactions
).omit({ transactionTimestamp: true });
export const insertFarmerCustomerFeedbackSchema = createInsertSchema(
  farmerCustomerFeedbacks
).omit({ feedbackTimestamp: true });
export const insertVendorFarmerFeedbackSchema = createInsertSchema(
  vendorFarmerFeedbacks
).omit({ feedbackTimestamp: true });
export const insertFarmerCustomerDisputeSchema = createInsertSchema(
  farmerCustomerDisputes
);
export const insertVendorFarmerDisputeSchema =
  createInsertSchema(vendorFarmerDisputes);
export const insertProductComplaintSchema = createInsertSchema(
  productComplaints
).omit({
  createdAt: true,
  updatedAt: true,
...
export type InsertFarmerCustomerOrder = z.infer<
  typeof insertFarmerCustomerOrderSchema
>;
export type FarmerCustomerOrder = typeof farmerCustomerOrders.$inferSelect;

export type InsertVendorFarmerOrder = z.infer<
  typeof insertVendorFarmerOrderSchema
>;
export type VendorFarmerOrder = typeof vendorFarmerOrders.$inferSelect;

export type InsertFarmerCustomerTransaction = z.infer<
  typeof insertFarmerCustomerTransactionSchema
>;
export type FarmerCustomerTransaction =
  typeof farmerCustomerTransactions.$inferSelect;

export type InsertVendorFarmerTransaction = z.infer<
  typeof insertVendorFarmerTransactionSchema
>;
export type VendorFarmerTransaction =
  typeof vendorFarmerTransactions.$inferSelect;

export type InsertFarmerCustomerFeedback = z.infer<
  typeof insertFarmerCustomerFeedbackSchema
>;
export type FarmerCustomerFeedback =
  typeof farmerCustomerFeedbacks.$inferSelect;

export type InsertVendorFarmerFeedback = z.infer<
  typeof insertVendorFarmerFeedbackSchema
>;
export type VendorFarmerFeedback = typeof vendorFarmerFeedbacks.$inferSelect;

export type InsertFarmerCustomerDispute = z.infer<
  typeof insertFarmerCustomerDisputeSchema
>;
export type FarmerCustomerDispute = typeof farmerCustomerDisputes.$inferSelect;

export type InsertVendorFarmerDispute = z.infer<
  typeof insertVendorFarmerDisputeSchema
>;
export type VendorFarmerDispute = typeof vendorFarmerDisputes.$inferSelect;

export type InsertProductComplaint = z.infer<
  typeof insertProductComplaintSchema
>;
