...
const seedProducts = [
  {
    ...
    stock: 150,
    description:
      "High yield, disease-resistant tomato seeds perfect for small to medium-sized farms.",
  },
  {
    id: 2,
    ...
    stock: 200,
    description:
      "Drought-resistant corn seeds that provide excellent harvest in various climate conditions.",
  },
  {
    id: 3,
    ...
    stock: 100,
    description:
      "Fast-growing lettuce seeds that are perfect for successive planting throughout the season.",
  },
  {
    id: 4,
    ...
    stock: 250,
    description:
      "High-yielding rice variety suitable for both irrigated and rainfed conditions.",
  },
  {
    id: 5,
    ...
    stock: 120,
    description:
      "Sweet, crunchy carrots that are perfect for market gardeners.",
  },
  {
    id: 6,
    name: "Wheat Seeds",
    ...
    stock: 180,
    description:
      "Premium wheat seeds with excellent disease resistance and high yield potential.",
  },
];
...
const equipmentProducts = [
  {
    ...
    stock: 10,
    description:
      "Efficient small-scale tractor suitable for most farming operations.",
  },
  {
    id: 2,
    ...
    stock: 30,
    description:
      "Water-efficient drip irrigation system for optimal crop watering.",
  },
  {
    id: 3,
    name: "Harvester",
    ...
    price: 1800,
    stock: 8,
    description: "Multi-crop harvester that saves time and labor costs.",
  },
];
...
const produceProducts = [
  {
    ...
    price: 5,
    stock: 500,
    description: "Organically grown tomatoes, harvested at peak ripeness.",
  },
  {
    id: 2,
    name: "Premium Corn",
    ...
    price: 3,
    stock: 800,
    description: "Sweet corn grown using sustainable farming practices.",
  },
  {
    id: 3,
...
export default function AdminDashboard() {
  ...
  const [queryHistory, setQueryHistory] = useState<
    { query: string; timestamp: Date; status: "success" | "error" }[]
  >([]);
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FBF7]">
      ...
      <div className="w-64 bg-[#33691E] text-white">
        ...
        <div className="mt-6">
          <button
            className={`w-full text-left p-3 pl-6 flex items-center space-x-3 ${
              activeTab === "dashboard"
                ? "bg-[#2E7D32] text-white"
                : "text-white hover:bg-[#2E7D32]/50"
            }`}
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-white/70">
                {user?.email || "admin@agrobuizz.com"}
              </p>
            </div>
          </div>
      ...
      <div className="flex-1 overflow-auto">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="dashboard">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[#33691E]">
                Dashboard Overview
              </h2>
                    ...
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        >
                          ...
                          <SelectContent>
                            {productCategories[
                              activeProductTab as keyof typeof productCategories
                            ]?.map((category) => (
          ...
          <TabsContent value="statistics">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[#33691E] mb-6">
                        ...
                        <TableRow key={order.id}>
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              {order.status === "processing" && (
                                <RefreshCw className="mr-1 h-3 w-3 text-blue-500 animate-spin" />
                              )}
                              {order.status === "shipped" && (
          ...
          <TabsContent value="database">
            <div className="p-8">
              ...
              <p className="text-gray-500 mb-6">
                Execute and view SQL database queries
              </p>
              ...
              <div className="grid grid-cols-1 gap-6 mb-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="farmers-with-crops">
                              Farmers with their crops
                            </SelectItem>
                            <SelectItem value="customers-with-multiple-orders">
                              Customers with 3+ orders
                            </SelectItem>
                            <SelectItem value="products-by-type">
                              Products by type
                            </SelectItem>
                            <SelectItem value="products-by-price-range">
                              Products by price range
                            </SelectItem>
                            <SelectItem value="available-products">
                              Available products with stock
                            </SelectItem>
                            <SelectItem value="products-by-vendor-ratings">
                              Products by vendor ratings
                            </SelectItem>
                            <SelectItem value="crops-for-sale">
                              Crops for sale
                            </SelectItem>
                            <SelectItem value="vendor-product-counts">
                              Products count by vendor
                            </SelectItem>
                            <SelectItem value="farmer-orders">
                              Farmer orders
                            </SelectItem>
                            <SelectItem value="disputes">
                              Disputes tracking
                            </SelectItem>
                            <SelectItem value="highly-rated-vendors">
                              Highly rated vendors
                            </SelectItem>
                            <SelectItem value="orders-by-year">
                              Orders by year (2025)
                            </SelectItem>
                            <SelectItem value="crop-sales">
                              Crop sales
                            </SelectItem>
                            <SelectItem value="farmers-with-multiple-disputes">
                        ...
                        <Button
                          ...
                          disabled={
                            ...
                            executePredefinedQuery.isPending
                          }
                        >
                          {executeQueryMutation.isPending ||
                          executePredefinedQuery.isPending ? (
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Query execution results will appear below
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0">
